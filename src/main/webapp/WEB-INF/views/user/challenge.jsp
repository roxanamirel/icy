...
<body>
	<div class="form-style-5">
		<form:form method="post"
			action="${pageContext.request.contextPath}/user/challengecreated"
			modelAttribute="challenge" value="/challengecreated">
			<fieldset>
				<legend>
					<span class="number">1</span> Challenge Info
				</legend>
				<form:input path="challengename" type="text" name="field1"
					placeholder="Name of Challenge *" />
				<form:textarea path="challengedesc" name="field2"
			...
			<fieldset>
				...
				<form:textarea path="challengeadditionalinfo" name="field4"
					placeholder="About Challenge"></form:textarea>
			</fieldset>
